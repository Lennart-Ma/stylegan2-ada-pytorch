...
def compute_feature_stats_for_generator(opts, detector_url, detector_kwargs, rel_lo=0, rel_hi=1, batch_size=64, batch_gen=None, jit=False, **stats_kwargs):
    ...
    while not stats.is_full():
        ...
        #### stats.num_items counts up to 50.000 in steps of 64 --> 781 steps
        #### ---> this means that 50.000 items are generated by the Generator
        #### ---> and afterwards used for calculating FID
        # print("Number of items: ")
        # print(stats.num_items)
    ...
    print()
    print()
    print("Number of images inside the Main loop for the fid: ")
    print(image_counter)
    print()
    print("Images list length")
    print(len(images))
    print()
    print("stats: ")
    print(stats)
